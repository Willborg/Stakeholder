...
def main():
    ...
    compare_cols = ["status", "nominator", "clearance_level", "date_cleared", "date_submitted"]
    required_cols = ["name", "company", "status", "nominator", "clearance_level", "date_submitted", "date_cleared"]
